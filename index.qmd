...
:::{ .g-col-12  .d-flex .fs-1 .flex-column .sloganMainPage .align-items-start }
...
```{ojs}
  ...
  hideSearch =  {
    if(textInput == "" || searchCityFilter.length == 0){
      ...
      if (!document.getElementById("searchTab").classList.contains("d-none")){
  ...
  showSearch =  {
    if (searchCityFilter.length > 0){
      ...
      if (document.getElementById("searchTab").classList.contains("d-none")){
        document.getElementById("searchTab").classList.remove("d-none");  
      }
    }
  }
