...
:::{.d-flex .justify-content-between .text-center .gap-3 .flex-column .flex-md-row}
...
:::{id="infoDistorcao" .g-col-12 .g-col-sm-6 .pt-2}
...
:::{id="infoRendimento" .g-col-12 .g-col-sm-6 .pt-2}
