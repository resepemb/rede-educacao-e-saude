        ...
        var chart = new chartjs.Chart(document.getElementById('matriculasChartBar'), {
          ...
          data: {
            ...
            datasets: [{
              label: '',
              data: [
                dados?.[0]?.[pesquisa_ano]?.Total ?? 0,
                dados?.[0]?.[pesquisa_ano]?.Masculina ?? 0,
                dados?.[0]?.[pesquisa_ano]?.Feminina ?? 0,
                dados?.[0]?.[pesquisa_ano]?.Nãodeclarada ?? 0,
                dados?.[0]?.[pesquisa_ano]?.Branca ?? 0,
                dados?.[0]?.[pesquisa_ano]?.Preta ?? 0,
                dados?.[0]?.[pesquisa_ano]?.Parda ?? 0,
                dados?.[0]?.[pesquisa_ano]?.Amarela ?? 0,
                dados?.[0]?.[pesquisa_ano]?.Indígena ?? 0,
                dados?.[0]?.[pesquisa_ano]?.Deficiência ?? 0
              ],
              borderWidth: 1,
              minBarLength: 10,
