...
```{ojs}
  ...
  updateChart =  function (){  
      ...
      try {
        clearChartGroup("myChartGroup", "myChart", document.body.clientWidth*0.45, "320")
...
:::{.fw-bold .fs-3}
Texto sobre quantidade de matriculas
:::
...
mutable selectedValue ="TotalGeral";
...
updateValue = {
  ...
  for (const radioButton of radioButtons) {
      radioButton.addEventListener('change', (event) => {
          mutable selectedValue = event.target.value;
      });
  }
}
...
<div class="form-check form-check-inline row fs-5">
  <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="TotalGeral" checked="true">
...
<div class="form-check form-check-inline row fs-5">
  <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="Feminino">
      ...
      try {
        ...
        data: 
        {
          ...
          datasets: [
            {
              label: 'Aprovação',
              data: [dados_rendimento[pesquisa_ano][selectedValue]["Total"].Aprovação, dados_rendimento[pesquisa_ano][selectedValue]["RacaNaoDeclarada"].Aprovação, dados_rendimento[pesquisa_ano][selectedValue]["Branca"].Aprovação, dados_rendimento[pesquisa_ano][selectedValue]["Preta"].Aprovação, dados_rendimento[pesquisa_ano][selectedValue]["Parda"].Aprovação, dados_rendimento[pesquisa_ano][selectedValue]["Amarela"].Aprovação,dados_rendimento[pesquisa_ano][selectedValue]["Indígena"].Aprovação, dados_rendimento[pesquisa_ano][selectedValue]["Deficiência"].Aprovação],
            ...
            {
              label: 'Reprovação',
              data: [dados_rendimento[pesquisa_ano][selectedValue]["Total"].Reprovação, dados_rendimento[pesquisa_ano][selectedValue]["RacaNaoDeclarada"].Reprovação, dados_rendimento[pesquisa_ano][selectedValue]["Branca"].Reprovação, dados_rendimento[pesquisa_ano][selectedValue]["Preta"].Reprovação, dados_rendimento[pesquisa_ano][selectedValue]["Parda"].Reprovação, dados_rendimento[pesquisa_ano][selectedValue]["Amarela"].Reprovação,dados_rendimento[pesquisa_ano][selectedValue]["Indígena"].Reprovação, dados_rendimento[pesquisa_ano][selectedValue]["Deficiência"].Reprovação],
              backgroundColor: 'rgba(75, 192, 192, 0.2)',
            ...
            {
              label: 'Abandono',
              data: [dados_rendimento[pesquisa_ano][selectedValue]["Total"].Abandono, dados_rendimento[pesquisa_ano][selectedValue]["RacaNaoDeclarada"].Abandono, dados_rendimento[pesquisa_ano][selectedValue]["Branca"].Abandono, dados_rendimento[pesquisa_ano][selectedValue]["Preta"].Abandono, dados_rendimento[pesquisa_ano][selectedValue]["Parda"].Abandono, dados_rendimento[pesquisa_ano][selectedValue]["Amarela"].Abandono,dados_rendimento[pesquisa_ano][selectedValue]["Indígena"].Abandono, dados_rendimento[pesquisa_ano][selectedValue]["Deficiência"].Abandono],
